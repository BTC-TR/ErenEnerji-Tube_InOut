		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tube In Out",
									"targetURL": "#comerentubeinout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerentubeinout-display": {
								"semanticObject": "comerentubeinout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eren.tubeinout",
									"url": sap.ui.require.toUrl("com/eren/tubeinout")
								}
							}
						}
					}
